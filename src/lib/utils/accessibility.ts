 ...
 */
export function generateAccessibleLinkClasses(variant: 'default' | 'button' | 'nav' = 'default'): string {
  const baseFocusClasses = 'focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 rounded-sm'

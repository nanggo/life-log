...
<svelte:head>
  ...
  <meta name="description" content={data.dynamicDescription || data.post.title} />
  ...
  <meta property="og:description" content={data.dynamicDescription || data.post.title} />
  ...
  <meta name="twitter:description" content={data.dynamicDescription || data.post.title} />

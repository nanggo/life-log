...
date: '2025-07-10'
updated: '2026-06-12T16:55:02+09:00'
tags:
  - git
draft: false
category: 개발
image: ./cover.webp
imageAlt: '여러 작업 트리가 나란히 열린 개발 책상 일러스트'
---
...
다만 모든 상황에서 필요한 건 아니다. 단순한 기능 개발이나 혼자 작업할 때는 기존 방식이 더 단순할 수 있다. 하지만 AI 도구를 활용한 병렬 개발에서는 이만한 도구가 없다.

덕분에 요즘은 Claude Code 세션을 두세 개 띄워놓고 작업하는 게 자연스러운 일과가 됐다. 한동안은 이 조합으로 계속 일하게 될 것 같다.

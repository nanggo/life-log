...
seoTitle: 'Street Coder 책 리뷰와 개발 기본기 회고'
description: '롱런하는 개발자가 되기 위해 기본기를 고민하던 시기에 읽은 Street Coder 리뷰다. 이론과 현실의 균형, 테스트, 리팩터링, 보안, 협업 같은 실전 개발자가 챙겨야 할 주제를 책 내용과 개인적인 인상으로 정리했다.'
...
category: 리뷰
image: ./cover.webp
imageAlt: '실전 개발 기본기를 떠올리게 하는 책과 도시의 밤 일러스트'
---

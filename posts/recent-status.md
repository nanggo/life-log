---
title: 근황
seoTitle: '가족, 구직, 사이드 프로젝트 근황'
description: '비자발적 휴식기 동안 가족과 보낸 시간, 구직 활동, 사이드 프로젝트, 읽고 있는 책을 정리한 근황 글이다. 면접을 바라보는 태도 변화, 코딩 테스트 준비, 다시 성장하려는 과정, 휴식기 일상의 균형과 결론을 함께 담았다.'

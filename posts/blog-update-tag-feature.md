...
seoTitle: 'SvelteKit 블로그 태그 기능 구현 기록'
description: '블로그 글이 늘어나며 원하는 글을 찾기 어려워진 문제를 태그 기능으로 해결한 과정이다. 태그 필터, 가로 스크롤, 선택 태그 고정, 미리보기 UI 개선까지 적용하며 실제 개인 블로그에서 필요한 탐색 경험을 정리했다.'
